            ...
            <div id='user_login' >
                <form action="" method="post" name="login_user" autocomplete="off">
                    <table  align=center width='100%' id='tab'>
                        <tr>
                            <th colspan=2 align=center style="background: black; height: 100px;color:white;">Login User</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align=center ><input name='sbtUser' type="submit" value="Login" class="Button2"></td>
                        </tr>
                    </table>
                </form>
            </div>
